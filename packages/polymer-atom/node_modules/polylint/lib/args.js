...
exports.argumentDefinitions = [
    ...
    },
    {
        ...
        defaultValue: '',
        alias: "r",
        description: ("Root directory against which URLs in inputs are resolved." +
    ...
    },
    {
        ...
        type: Boolean,
        defaultValue: false,
        description: ("If true, the file from `input` will be replaced by the contents of stdin." +
